<template>
	<div class="rankingboxlist">
		<div class="bookstop">
			<div class="back">
				<div class="icon-cheveron-left" @click="back"></div>
				<div class="title">
					{{rankingsbooks.shortTitle}}
				</div>
			</div>
		...
		<div class="textboxs">
			<div class="books-searchbox" v-for="item in rankingsbooks.books" :key="item._id" @click="bookgo({id:item._id,name:item.title})">
				<div class="imgsbook">
